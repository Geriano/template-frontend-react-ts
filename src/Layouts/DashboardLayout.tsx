...
export const SidebarLink = ({ icon, name, to, open }: SidebarLinkProps) => {
  ...
  return (
    <Link to={to}>
      <div 
        className={classNames("flex items-center space-x-1 text-white hover:bg-primary-1 py-2 px-4 text-md transition-all duration-300", {
          'justify-center': !open,
          'bg-primary-1': active,
          'border-l-8 border-b-0 border-primary-2': active && open,
        })}
      >
        <i className={icon}></i>
...
export default function DashboardLayout() {
  ...
  return (
    <>
      <div onClick={focusout} className="relative flex w-full h-screen bg-gray-200 text-gray-700 dark:bg-gray-900 dark:text-gray-300 text-sm font-sans">
        <div className={classNames("flex-none flex flex-col h-screen bg-primary-0 overflow-y-auto transition-all duration-300 shadow-xl", {
          'w-56': open.sidebar,
          'w-12': !open.sidebar,
        })}>
          <div className={classNames("sticky top-0 z-10 flex-none flex items-center w-full h-14 text-white", {
            ...
            <h1 className={classNames("text-xl text-center font-bold", {
              'hidden': !open.sidebar,
            })}>
            ...
            <div className='flex-none flex items-center justify-center w-8 h-8'>
              <Button
                ...
                className='px-0 py-0 text-xl shadow-none'
              >
        ...
        <div className="flex flex-col w-full h-screen overflow-y-auto">
          <div className="sticky top-0 z-10 flex-none flex items-center justify-end w-full h-14 bg-gray-50 dark:bg-gray-800 border-b dark:border-gray-700 px-4">
            <div className="relative flex items-center justify-end w-full max-w-xs dark:text-gray-300">
              ...
              <div className="flex-none flex items-center justify-center w-16 h-16 p-2">
                <Button 
                  ...
                  className='flex-none text-xl shadow-none'
                >
              ...
              >
                ...
                <Button 
                  onClick={signout}
                  className='w-full rounded-none border-b dark:border-gray-600 px-0 dark:hover:text-gray-50 py-1 shadow-none'
                >
